...
export default function AdminPage() {
  ...
  const revenue = orders.filter((o) => !['pending_payment', 'cancelled'].includes(o.status)).reduce((sum, o) => sum + Number(o.total_amount || 0), 0);
...
const styles = { page:{minHeight:'100vh',background:'#0b0b0a',color:'#f7f6f3',padding:'40px 20px',fontFamily:'Arial,Helvetica,sans-serif'},shell:{maxWidth:1120,margin:'0 auto'},header:{display:'flex',justifyContent:'space-between',alignItems:'flex-end',gap:25,borderBottom:'1px solid #302e29',paddingBottom:25,marginBottom:22},kicker:{fontSize:10,letterSpacing:2,color:'#8b887f',marginBottom:8},title:{fontSize:'clamp(55px,9vw,95px)',lineHeight:.85,margin:0,letterSpacing:-4},sub:{color:'#aaa69d',maxWidth:620,lineHeight:1.5,margin:'14px 0 0'},headerActions:{display:'flex',alignItems:'center',gap:15,flexWrap:'wrap'},link:{color:'#aaa69d',textDecoration:'none',fontSize:10,letterSpacing:1},logout:{background:'transparent',border:'1px solid #555',color:'#fff',padding:'10px 14px',cursor:'pointer',fontSize:10,letterSpacing:1},error:{padding:14,border:'1px solid #7c4b47',background:'#17100f',color:'#ff8178',marginBottom:18,fontSize:13},stats:{display:'grid',gridTemplateColumns:'repeat(3,1fr)',gap:10,marginBottom:18},stat:{border:'1px solid #302e29',background:'#11110f',padding:20,minWidth:0},statSpan:{fontSize:9},sectionHead:{display:'flex',justifyContent:'space-between',gap:20,alignItems:'center',paddingBottom:18,borderBottom:'1px solid #25231f'},sectionTitle:{fontSize:12,letterSpacing:2,fontWeight:700},hint:{fontSize:12,color:'#77736b',margin:'7px 0 0'},count:{fontSize:9,color:'#77736b',letterSpacing:1},search:{width:260,maxWidth:'100%',border:'1px solid #3a3731',background:'#0b0b0a',color:'#fff',padding:'11px 12px',outline:'none'},orders:{display:'grid'},orderRow:{display:'grid',gridTemplateColumns:'1.5fr 1.2fr auto',gap:15,alignItems:'center',padding:'15px 0',borderBottom:'1px solid #25231f',fontSize:12},amount:{fontSize:12,textAlign:'right'},userRow:{display:'grid',gridTemplateColumns:'1.5fr 1.2fr auto auto',gap:15,alignItems:'center',padding:'16px 0',borderBottom:'1px solid #25231f',fontSize:12},email:{fontSize:11,color:'#77736b',marginTop:5},meta:{fontSize:9,color:'#77736b',fontFamily:'monospace',lineHeight:1.5},badge:{padding:'6px 8px',fontSize:9,letterSpacing:1,fontWeight:700},enabled:{background:'#18351e',color:'#9cffaa'},disabled:{background:'#333',color:'#aaa'},smallButton:{background:'transparent',border:'1px solid #444',color:'#ddd',padding:'8px 10px',fontSize:9,letterSpacing:1,cursor:'pointer'},empty:{color:'#777',fontSize:13},card:{border:'1px solid #302e29',background:'#11110f',padding:24,marginBottom:18},grid:{display:'grid',gridTemplateColumns:'1fr 1fr',gap:18},feature:{position:'relative',border:'1px solid #302e29',background:'#11110f',padding:28,minHeight:210,textDecoration:'none',color:'#f7f6f3',display:'flex',flexDirection:'column'},featureKicker:{fontSize:9,letterSpacing:2,color:'#8b887f',marginBottom:22},featureTitle:{fontSize:38,lineHeight:1},featureText:{color:'#8b887f',fontSize:12,marginTop:'auto',paddingRight:35},arrow:{position:'absolute',right:25,bottom:20,fontSize:25},bottomNav:{display:'flex',gap:18,flexWrap:'wrap',marginTop:24},bottomLink:{color:'#777',textDecoration:'none',fontSize:10,letterSpacing:1},muted:{color:'#777',padding:40,textAlign:'center'}};
