...
.shell .brand{color:#111!important}.shell .brand-mark{background:#e1261c!important}
...
@media(max-width:700px){.shell .hero{min-height:620px!important}.shell .hero h1{font-size:clamp(48px,15vw,78px)!important}.shell .section{padding:60px 0!important}.shell .category-grid{grid-template-columns:repeat(2,1fr)!important}.shell .product-grid{grid-template-columns:1fr!important}.shell .product-image{height:360px!important}.page{padding:24px!important}}
`;
