  ...
  return (
    <main className="auth-shell">
      <section className="auth-card">
        ...
        {!isReset && mode === 'login' && <>
          <button className="google-button" type="button" onClick={handleGoogleLogin} disabled={googleLoading || loading}>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button className="submit" type="submit" disabled={loading || googleLoading}>{loading ? 'MEMPROSES...' : isReset ? 'KIRIM LINK RESET' : mode === 'login' ? 'MASUK' : 'DAFTAR'}</button>
        </form>
