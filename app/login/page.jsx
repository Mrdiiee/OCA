    ...
    if (mode === 'register') {
      ...
      const { data, error: signUpError } = await supabase.auth.signUp({
        ...
        options: {
          ...
          data: { full_name: fullName.trim(), phone: phone.trim(), address: address.trim(), city: city.trim(), postal_code: postalCode.trim() },
        },
      });
      ...
      setMessage('Akun berhasil dibuat. Cek email Anda untuk konfirmasi sebelum login.');
      setLoading(false);
      return;
    }
