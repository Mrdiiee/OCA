...
export async function PATCH(request) {
  ...
  try {
    ...
    if (body.name !== undefined || body.slug !== undefined || body.description !== undefined || body.price !== undefined || body.stock !== undefined || body.imageUrl !== undefined) {
      ...
      merged = {
        ...merged,
        name: body.name !== undefined ? p.name : merged.name,
        slug: body.slug !== undefined ? p.slug : merged.slug,
        description: body.description !== undefined ? p.description : merged.description,
